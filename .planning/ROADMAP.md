...
- [x] 03-02-PLAN.md -- Animation data hooks on SVG diagrams and all section components
- [x] 03-03-PLAN.md -- GSAP installation, AnimationScript orchestration, and page assembly with decorative elements
