...
- [ ] **FOUN-01**: Site builds as static HTML with zero client-side JS for content rendering
...
- [ ] **FOUN-04**: Dark color palette avoids halation (off-white on dark gray, no pure white on pure black)
- [ ] **FOUN-05**: Typography system loaded with font preloading (display, body, monospace)
